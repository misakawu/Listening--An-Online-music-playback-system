<template>
  ...
  <div class="container">
    ...
    <el-table height="550px" border size="small" :data="data" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="歌手名" prop="musician_name" width="150" align="center"></el-table-column>
      ...
      <el-table-column label="音乐地址" prop="music_data" width="250" align="center"></el-table-column>
      <el-table-column label="评论歌曲" width="150" align="center">
        <template v-slot="scope">
          <el-button @click="goCommentPage(scope.row.id)">评论</el-button>
        </template>
      </el-table-column>
      <el-table-column label="收藏数" prop="like" width="120" align="center"></el-table-column>
